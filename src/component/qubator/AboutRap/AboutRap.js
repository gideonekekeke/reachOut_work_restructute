...
const AboutRap = () => {
  return (
    <div class="p-6 mx-auto mt-dtop  w-full rounded-xl flex-wrap  flex  justify-center space-x-4">

  <div>
    <div class="text-SM font-medium text-left text-gid-col text-black">ABOUT US</div>
    <p class="font-medium text-left text-black text-3xl">Rhapsody of Realities is  <br/>no  ordinary book</p>
          </div>
          <div className = 'text-left'>
           ...
           <button style = {{width : '150px', height : '50px'}} class="rounded-full ml-5 text-white  bg-gid-col mt-3">Read More</button>
          </div>
</div>
  )
}
